...
class MenuMagazinesEventsView extends ConsumerWidget {
  const MenuMagazinesEventsView({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final MaxSizePhone maxSizePhone = ref.watch(maxConstrainsProvider);
    return CustomOptionPrincipalMenu(
      pImageUrl: magazineItemMenuImage,
      pTitle: 'Revista digital',
      pSubTitle: 'Ingrese para ver las ediciones revista bike digital',
      pOnTap: () => context.push('/home-magazine'),
